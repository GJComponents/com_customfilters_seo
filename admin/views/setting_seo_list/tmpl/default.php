...
//                    die(__FILE__ .' '. __LINE__ );
                     ...
                     * [id] => 1
                        [vmcategory_id] => 2922
                        [url_params] => /filter/metallocherepitsa/
                        [url_params_hash] => a304d4cf7315804c1d7fbe00e2071a11
                        [sef_url] => /catalog/metalocherepitsa/
                        [no_ajax] => 1
                    */
					?>
					<tr>
						...
						<td>
							<div class="name break-word">
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo Route::_('index.php?option=com_customfilters&view=setting_seo&layout=edit&id=' . (int)$item->id); ?>"
                                       title="<?php echo Text::sprintf('COM_VM_SEO_PRODUCT_FILTER_GRTS_EDIT_VM_SEO_PRODUCT_FILTER_GRT', $this->escape($item->title)); ?>">
                                        <?php echo $this->escape($item->sef_url); ?></a>
                                <?php else : ?>
