...
class CustomfiltersControllerSetting_seo extends \Joomla\CMS\MVC\Controller\AdminController
{
	...
	public function apply()
	{
		...
		$this->setRedirect( 'index.php?option=com_customfilters&view=setting_seo&layout=edit&id='.$id );
	}
	...
	public function save()
	{
		...
		{
			$this->setMessage( Text::_( 'COM_CUSTOMFILTERS_SETTING_SEO_SAVED_SUCCESS' ) );
		}
		if ( $task == 'save' )
		{
			// Выход в список
			$this->setRedirect( 'index.php?option=com_customfilters&view=setting_seo_list' );
		}#END IF
	...
	public function cancel():bool
	{
		...
		$this->setRedirect( Route::_( 'index.php?option=com_customfilters&view=setting_seo_list' , false ) );
		return true;
	}
