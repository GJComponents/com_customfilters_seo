 ...
 * @package customfilters
 */
class CustomfiltersControllerSetting_city_list extends \Joomla\CMS\MVC\Controller\AdminController
{

	/**
	 * Удаление записей из списка in view - Admin List
	 * DOCS :
	 *      https://www.techfry.com/joomla-api/joomla-delete-method-of-admin-controller
	 *      https://www.techfry.com/joomla-api/joomla-delete-method-of-admin-model
	 * @return void
	 * @throws Exception
	 * @since 3.9
	 */
...
//	        die(__FILE__ .' '. __LINE__ );
	...
	/**
	 * Создайте массив с параметрами в виде строки json
	 ...
	 * @author Sakis Terz
	 */
    public function formatParams(array $params_array): array
    {
